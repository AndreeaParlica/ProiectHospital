...
if(isset($_GET['cancel']))
  {
    ...
    if($query)
    {
      echo "<script>alert('Programarea ta a fost efectuata cu succes!');</script>";
    }
  }
  ...
  if(isset($_GET['prescribe'])){
    ...
    if($query)
    {
      echo "<script>alert('Tratament prescris cu success!');</script>";
    }
    else{
      echo "<script>alert('Cererea nu a putut fi efectuata. Incearca din nou!');</script>";
    }
  }
...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="imagines/" />
...
.text-primary {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" method="post" action="search.php">
      ...
      <input type="submit" class="btn btn-outline-light" id="inputbtn" name="search_submit" value="Cauta">
    </form>
  </div>
</nav>
  </head>
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Bine ai venit &nbsp<?php echo $_SESSION['dname'] ?>  </h3>
    <div class="row">
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      <a class="list-group-item list-group-item-action active" href="#list-dash" role="tab" aria-controls="home" data-toggle="list">Dashboard</a>
      <a class="list-group-item list-group-item-action" href="#list-app" id="list-app-list" role="tab" data-toggle="list" aria-controls="home">Programari</a>
      <a class="list-group-item list-group-item-action" href="#list-pres" id="list-pres-list" role="tab" data-toggle="list" aria-controls="home"> Lista tratamente</a>
               ...
               <div class="col-sm-4" style="left: 10%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Acceseaza programari</h4>
                      <script>
                ...
                <div class="col-sm-4" style="left: 15%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <h4 class="StepTitle" style="margin-top: 5%;"> Tratamente</h4>
                     ...
                     <td>
                        ...
                        { ?>
	                        ...
	                        <a href="doctor-panel.php?ID=<?php echo $row['ID']?>&cancel=update" 
                              onClick="return confirm('Sigur anulam?')"
                              title="Anuleaza programarea" tooltip-placement="top" tooltip="Remove"><button class="btn btn-danger">Anuleaza</button></a>
	                        <?php } else {
                        ...
                        <button class="btn btn-success">Reteta</button></a>
                        <?php } else {
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Taxa consulatie</th>
                    <th scope="col">Data programare</th>
                    <th scope="col">Ora programare</th>
                  </tr>
                </thead>
